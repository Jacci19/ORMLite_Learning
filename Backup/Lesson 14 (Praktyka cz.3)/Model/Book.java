...
public class Book  implements BaseModel{                                    //ta klasa będzie tabelą w naszej BD
    ...
    @DatabaseField(columnName = "AUTHOR_ID", foreign = true, foreignAutoCreate = true, foreignAutoRefresh = true)   //ozn. że jest to element z innej tabeli, będzie zwracał id authora (id pozycji z innej tabeli)
    private Author author;                                                          //dwa ostatnie dają nam auto-odświeżanie przez co w mainie może być mniej poleceń
